...
public class AcitonSheet extends Fragment implements View.OnClickListener{
	 private static final String ARG_CANCEL_BUTTON_TITLE = "cancel_button_title";
	    ...
	    private View createView() {
	        ...
	        mBg.setId(AcitonSheet.BG_VIEW_ID);
	    ...
	    private void createItems() {
	        ...
	        bt.setTextSize(TypedValue.COMPLEX_UNIT_PX, mAttrs.actionSheetTextSize);
	        bt.setId(AcitonSheet.CANCEL_BUTTON_ID);
	    ...
	    public void onClick(View v) {
	        if (v.getId() == AcitonSheet.BG_VIEW_ID && !getCancelableOnTouchOutside()) {
	            return;
	        }
	        dismiss();
	        if (v.getId() != AcitonSheet.CANCEL_BUTTON_ID && v.getId() != AcitonSheet.BG_VIEW_ID) {
	            if (mListener != null) {
	    ...
	    public static class Builder {
	        ...
	        public AcitonSheet show() {
	        	AcitonSheet actionSheet = (AcitonSheet) Fragment.instantiate(
	                    mContext, AcitonSheet.class.getName(), prepareArguments());
	    ...
	    public static interface ActionSheetListener {
	        ...
	        void onDismiss(AcitonSheet actionSheet, boolean isCancel);

	        void onOtherButtonClick(AcitonSheet actionSheet, int index);
	    }
}
